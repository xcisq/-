(function () {
	...
	Colorpicker.prototype = {
		init(opt) {
			...
			div.id = 'colorPanel';
			document.getElementById("selfShadow").appendChild(div)
			this.elem_wrap = div;
			...
			var top = elem.offsetTop;		// 绑定元素offsetTop
			...
			this.pancelLeft = this.elem_colorPalette.clientWidth;
			this.pancelTop = this.bindElem.offsetHeight;
				...
				if (e.target.tagName.toLocaleLowerCase() == "p") {
					...
					switch (_this.current_mode) {
						case "hex":
							...
							_this.Opt.change(_this.bindElem, _this.resultHex)
							break;
						case 'rgb':
		...
		render: function () {
			var tpl =
				...
				<div style="position: inherit;display: flex;">
						...
						<div style="width: 100%; padding-bottom: 55%; position: relative; border-radius: 2px 2px 0px 0px; overflow: hidden;">
							<div class="color-pancel" style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px; background: rgb(${this.rgba.r},${this.rgba.g},${this.rgba.b})">
								...
								<div class="saturation-white" style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px;">
									...
									<div class="pickerBtn" style="position: absolute; top: 0; left: 0; cursor: pointer;">
							...
							<div class="flexbox-fix" style="display: flex;align-items: center;height: 40px;">
								<div style="width: 32px;">
									<div style="width: 16px; height: 16px; border-radius: 8px; position: relative; overflow: hidden;">
										<div class="colorpicker-showColor" style="position: absolute; top: 0px; right: 0px; bottom: 0px; left: 0px; border-radius: 8px; box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 0px 1px inset; background:rgb(${this.rgba.r},${this.rgba.g},${this.rgba.b});"></div>
		...
		setPosition(x, y) {
			...
			const shadow = document.getElementById("selfShadow");
			this.pancelLeft = cursorArea.offsetWidth + shadow.offsetLeft + this.elem_colorPalette.clientWidth;
			this.pancelTop = shadow.offsetTop + document.getElementById("colorPanel").offsetTop;
		...
		changeViewByHsb: function () {
			...
			// var hex = '#' + this.rgbToHex(this.HSBToRGB(this.hsb));
			// this.Opt.change(this.bindElem, hex);
			this.resultHex = '#' + this.rgbToHex(this.HSBToRGB(this.hsb));
		},
		...
		bindMove: function (elem, fn, bool) {
			...
			elem.addEventListener("mousedown", function (e) {
				...
				_this.downY = e.pageY;
				// 修改
				_this.pancel_width = _this.elem_colorPancel.offsetWidth;
				_this.pancel_height = _this.elem_colorPancel.offsetHeight;
